...
package lxp.adebug.mvvmlib.crash;
...
public final class CustomActivityOnCrash {
    ...
    private static LibConfig config = new LibConfig();
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            if (config.isEnabled()) {
                                ...
                                if (hasCrashedInTheLastSeconds(application)) {
                                    ...
                                    } else if (config.getBackgroundMode() == LibConfig.BACKGROUND_MODE_SHOW_CUSTOM || !isInBackground) {
                                    ...
                                    } else if (config.getBackgroundMode() == LibConfig.BACKGROUND_MODE_CRASH) {
                                        if (oldHandler != null) {
                                            oldHandler.uncaughtException(thread, throwable);
                                            return;
                                        }
     ...
     */
    @NonNull
    public static LibConfig getConfigFromIntent(@NonNull Intent intent) {
        return (LibConfig) intent.getSerializableExtra(CustomActivityOnCrash.EXTRA_CONFIG);
    }
     ...
     */
    public static void restartApplicationWithIntent(@NonNull Activity activity, @NonNull Intent intent, @NonNull LibConfig config) {
    ...
    public static void restartApplication(@NonNull Activity activity, @NonNull LibConfig config) {
     ...
     * @param config   The config object as obtained by calling getConfigFromIntent.
     */
    public static void closeApplication(@NonNull Activity activity, @NonNull LibConfig config) {
        if (config.getEventListener() != null) {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static void setConfig(@NonNull LibConfig config) {
