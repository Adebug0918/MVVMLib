...
-keep class lxp.adebug.mvvmlib.http.BaseResponse { *; }
...
#---------------------------------4.反射相关的类和方法-----------------------
-keep public class * extends lxp.adebug.mvvmlib.base.BaseActivity{ *; }
-keep public class * extends lxp.adebug.mvvmlib.base.BaseFragment{ *; }
-keep public class * extends lxp.adebug.mvvmlib.binding.command.BindingCommand{ *; }
-keep public class * extends lxp.adebug.mvvmlib.binding.command.ResponseCommand{ *; }
